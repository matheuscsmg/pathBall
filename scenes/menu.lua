...
function scene:create()
	...
	transition.to(cannon, {time = 4000, rotation = -90, iterations = 0, transition = easing.continuousLoop})

	local numTiles = math.ceil(_W / 64 / 2)
	for i = -numTiles - 4, numTiles + 4 do -- Add extra 4 on the sides for resize events
		local tile = display.newImageRect(bottomGroup, 'images/green_tiles/3.png', 64, 114)
		tile.anchorY = 1
